...
namespace async
{
    ...
    SQLITE_API int sqlite3_open_v2(
        ...
        dmq::Duration timeout = MAX_WAIT /* Timeout duration */
    );
    ...
    SQLITE_API int sqlite3_limit(sqlite3*, int id, int newVal, dmq::Duration timeout = MAX_WAIT);
    ...
    SQLITE_API int sqlite3_busy_timeout(sqlite3*, int ms, dmq::Duration timeout = MAX_WAIT);

    SQLITE_API int sqlite3_busy_handler(sqlite3*, int(*)(void*, int), void*, dmq::Duration timeout = MAX_WAIT);
    ...
    SQLITE_API int sqlite3_bind_blob64(sqlite3_stmt*, int, const void*, sqlite3_uint64,
        void(*)(void*), dmq::Duration timeout = MAX_WAIT);
    ...
    SQLITE_API int sqlite3_bind_text64(sqlite3_stmt*, int, const char*, sqlite3_uint64,
        void(*)(void*), unsigned char encoding, dmq::Duration timeout = MAX_WAIT);
    ...
    SQLITE_API void sqlite3_result_blob(sqlite3_context*, const void*, int, void(*)(void*), dmq::Duration timeout = MAX_WAIT);
    SQLITE_API void sqlite3_result_blob64(sqlite3_context*, const void*,
        sqlite3_uint64, void(*)(void*), dmq::Duration timeout = MAX_WAIT);
    SQLITE_API void sqlite3_result_double(sqlite3_context*, double, dmq::Duration timeout = MAX_WAIT);
    SQLITE_API void sqlite3_result_error(sqlite3_context*, const char*, int, dmq::Duration timeout = MAX_WAIT);
    SQLITE_API void sqlite3_result_error16(sqlite3_context*, const void*, int, dmq::Duration timeout = MAX_WAIT);
    SQLITE_API void sqlite3_result_error_toobig(sqlite3_context*, dmq::Duration timeout = MAX_WAIT);
    SQLITE_API void sqlite3_result_error_nomem(sqlite3_context*, dmq::Duration timeout = MAX_WAIT);
    SQLITE_API void sqlite3_result_error_code(sqlite3_context*, int, dmq::Duration timeout = MAX_WAIT);
    SQLITE_API void sqlite3_result_int(sqlite3_context*, int, dmq::Duration timeout = MAX_WAIT);
    SQLITE_API void sqlite3_result_int64(sqlite3_context*, sqlite3_int64, dmq::Duration timeout = MAX_WAIT);
    SQLITE_API void sqlite3_result_null(sqlite3_context*, dmq::Duration timeout = MAX_WAIT);
    SQLITE_API void sqlite3_result_text(sqlite3_context*, const char*, int, void(*)(void*), dmq::Duration timeout = MAX_WAIT);
    SQLITE_API void sqlite3_result_text64(sqlite3_context*, const char*, sqlite3_uint64,
        void(*)(void*), unsigned char encoding, dmq::Duration timeout = MAX_WAIT);
    SQLITE_API void sqlite3_result_text16(sqlite3_context*, const void*, int, void(*)(void*), dmq::Duration timeout = MAX_WAIT);
    SQLITE_API void sqlite3_result_text16le(sqlite3_context*, const void*, int, void(*)(void*), dmq::Duration timeout = MAX_WAIT);
    SQLITE_API void sqlite3_result_text16be(sqlite3_context*, const void*, int, void(*)(void*), dmq::Duration timeout = MAX_WAIT);
    SQLITE_API void sqlite3_result_value(sqlite3_context*, sqlite3_value*, dmq::Duration timeout = MAX_WAIT);
    SQLITE_API void sqlite3_result_pointer(sqlite3_context*, void*, const char*, void(*)(void*), dmq::Duration timeout = MAX_WAIT);
    SQLITE_API void sqlite3_result_zeroblob(sqlite3_context*, int n, dmq::Duration timeout = MAX_WAIT);
    SQLITE_API int sqlite3_result_zeroblob64(sqlite3_context*, sqlite3_uint64 n, dmq::Duration timeout = MAX_WAIT);

    SQLITE_API void sqlite3_result_subtype(sqlite3_context*, unsigned int, dmq::Duration timeout = MAX_WAIT);
    ...
    SQLITE_API int sqlite3_enable_load_extension(sqlite3* db, int onoff, dmq::Duration timeout = MAX_WAIT);

    SQLITE_API sqlite3_str* sqlite3_str_new(sqlite3*, dmq::Duration timeout = MAX_WAIT);
    SQLITE_API char* sqlite3_str_finish(sqlite3_str*, dmq::Duration timeout = MAX_WAIT);

    SQLITE_API void sqlite3_str_append(sqlite3_str*, const char* zIn, int N, dmq::Duration timeout = MAX_WAIT);
    SQLITE_API void sqlite3_str_appendall(sqlite3_str*, const char* zIn, dmq::Duration timeout = MAX_WAIT);
    SQLITE_API void sqlite3_str_appendchar(sqlite3_str*, int N, char C, dmq::Duration timeout = MAX_WAIT);
    SQLITE_API void sqlite3_str_reset(sqlite3_str*, dmq::Duration timeout = MAX_WAIT);

    SQLITE_API int sqlite3_str_errcode(sqlite3_str*, dmq::Duration timeout = MAX_WAIT);
    SQLITE_API int sqlite3_str_length(sqlite3_str*, dmq::Duration timeout = MAX_WAIT);
    SQLITE_API char* sqlite3_str_value(sqlite3_str*, dmq::Duration timeout = MAX_WAIT);
